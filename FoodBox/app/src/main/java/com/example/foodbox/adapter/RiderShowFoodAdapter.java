...
import com.example.foodbox.model.RiderFood;
import com.example.foodbox.restaurant.RestaurantRegister;
import com.example.foodbox.rider.RiderDashboard;
import com.example.foodbox.rider.RiderShowOrder;
import com.example.foodbox.rider.RiderUserLocation;
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.btn_completed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, RiderDashboard.class);
                mContext.startActivity(intent);
            }
        });
    }
